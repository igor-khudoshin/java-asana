...
import java.util.List;
    ...
    public class StatusesBase extends Resource {
    /**
    * @param client Parent client instance
    */
    public StatusesBase(Client client) { super(client); }
        ...
        */
        public ItemRequest<JsonElement> deleteStatus(String statusGid, List<String> optFields, Boolean optPretty) throws IOException {
            String path = "/statuses/{status_gid}".replace("{status_gid}", statusGid);
        ...
        */
        ...
        /**
        * Get statuses from an object
        * Returns the compact status update records for all updates on the object.
            * @param publishedSince Only return statuses that have been published since the given time. (optional)
            * @param parent Globally unique identifier for object to fetch statuses on. (optional)
            * @param offset Offset token. An offset to the next page returned by the API. A pagination request will return an offset token, which can be used as an input parameter to the next request. If an offset is not passed in, the API will return the first page of results. &#x27;Note: You can only pass in an offset that was returned to you via a previously paginated request.&#x27; (optional)
            * @param limit Results per page. The number of objects to return per page. The value must be between 1 and 100. (optional)
            * @param optFields Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional)
            * @param optPretty Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional)
        ...
        * @throws IOException If we fail to call the API, e.g. server error or cannot deserialize the response body
        */
        public CollectionRequest<JsonElement> getStatusesForObject(OffsetDateTime publishedSince, String parent, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
            String path = "/statuses";
            ...
            CollectionRequest<JsonElement> req = new CollectionRequest<JsonElement>(this, JsonElement.class, path, "GET")
                ...
                .query("offset", offset)
                .query("parent", parent)
                .query("published_since", publishedSince);

            return req;
        }

        public CollectionRequest<JsonElement> getStatusesForObject(OffsetDateTime publishedSince, String parent) throws IOException {
            return getStatusesForObject(publishedSince, parent, null, (int)Client.DEFAULTS.get("page_size"), null, false);
        }
    }
